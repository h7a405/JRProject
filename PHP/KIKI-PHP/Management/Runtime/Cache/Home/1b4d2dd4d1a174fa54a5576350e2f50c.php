...
<head lang="en">
    <meta charset="UTF-8">
    <title>Log - <?php echo ($title); ?></title>
</head>
<body>
<!DOCTYPE html>
<html>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="table-responsive breadcrumb">
        <caption>
            <form class="bs-example bs-example-form form-inline" role="form" method="get" action="<?php echo U('Log/index');?>">
                <div class="row">
                    <div class="form-inline pull-right">
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group">
                                <button type="submi" class="btn btn-default" value="20" name="pageSize">默认</button>
                    ...
                    <div class="col-lg-8 form-inline">
                        ...
                        <div class="control-label form-group">
                            <select name="keywordType" class="form-control">
                                ...
                                <?php if(is_array($fields)): $i = 0; $__LIST__ = $fields;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["value"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
        ...
        <table class="table table-hover table-condensed" style="text-align: center; background-color: white; margin-top: 20px;">
            <thead>
                <tr>
                    <th width="5%">编号</th>
                    <th>日志操作账号</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["addedbyname"]); ?></td>
                    <td><?php echo ($vo["operatedmodulename"]); ?></td>
                    <td><?php echo ($vo["operatedfunctionname"]); ?></td>
