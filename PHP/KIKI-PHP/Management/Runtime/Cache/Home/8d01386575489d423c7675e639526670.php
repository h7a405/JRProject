...
<head lang="en">
    <meta charset="UTF-8">
    <title>editPermission - <?php echo ($title); ?></title>
</head>
<body>
<!DOCTYPE html>
<html>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="form-horizontal">
        <div id="body-wrap" class="breadcrumb">
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-4">
                    <label class="control-label"><?php echo ($permission["name"]); ?></label>
                </div>
            </div>

            <div class="form-group row has-feedback">
                <label class="col-sm-2 control-label">对应URL：</label>
                <div class="col-sm-4">
                    <label class="control-label"><?php echo ($permission["name_father"]); ?></label>
                </div>
            </div>
            ...
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-4">
                    <label class="control-label"><?php echo ($permission["datetime_added"]); ?></label>
                </div>
            </div>
            ...
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-4">
                    <label class="control-label"><?php echo ($permission["username_added"]); ?></label>
                </div>
            </div>
            ...
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-2">
                    <?php if($permission["type"] == 0): ?><span class="label label-default">全局通用</span>
            ...
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-2">
                    <?php if($permission["isenabled"] == 0): ?><span class="label label-default control-label">不可用</span>
                        <?php else: ?>
            ...
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-4">
                    <label class="control-label"><?php echo ($permission["introduction"]); ?></label>
                </div>
            </div>
    ...
    <div class="breadcrumb">
        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo U('Permission/editThePermission');?>" style="margin-top: 20px;">
            <input type="hidden" name="edit_permission[id]" value="<?php echo ($permission["id"]); ?>">
            <div class="form-group row has-feedback">
                <label class="col-sm-2 control-label">更改权限名：</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="edit_permission[name]" placeholder="名称" style="display:inline-block;width: 60%;" value="<?php echo ($permission["name"]); ?>">
                </div>
            </div>

            <div class="form-group row has-feedback">
                <label class="col-sm-2 control-label">更改对应URL：</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" style="display:inline-block;" value="<?php echo ($permission["name_father"]); ?>" disabled>
                </div>
                <p class="help-block">*对应的URL无法更改</p>
            </div>
            ...
            <div class="form-group row has-feedback">
                <label class="col-sm-2 control-label">更改权限类型：</label>
                <div class="col-sm-4">
                    <select name="edit_permission[type]" class="form-control">
                        <?php if($permission["type"] == 0): ?><option value="0" selected>全局通用</option>
            ...
            <div class="form-group row has-feedback">
                ...
                <div class="col-sm-2">
                    <select name="edit_permission[isenabled]" class="form-control">
                        <?php if($permission["isenabled"] == 0): ?><option value="0" selected>不可用</option>
