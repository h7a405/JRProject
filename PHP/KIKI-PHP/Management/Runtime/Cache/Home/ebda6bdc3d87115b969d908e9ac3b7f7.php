...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="table-responsive breadcrumb">
        <caption>
            <form class="bs-example bs-example-form form-inline" role="form" method="get" action="<?php echo U('Menu/index');?>">
                <div class="row">
        ...
        <table class="table table-hover table-condensed" style="background-color: white; margin-top: 20px;">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <?php if($vo["level"] == 0): ?><span class="label label-danger">父级菜单</span>
                        <?php else: ?>
                            <span class="label label-info"><?php echo ($vo["name_father"]); ?></span><?php endif; ?>
                    </td>
                    <td>
                        <?php if($vo["type"] == 0): ?><span class="label label-default">未定义</span>
                    ...
                    <td>
                        <?php if($vo["isvisible"] == 0): ?><span class="label label-default">隐藏</span>
                        <?php else: ?>
                            <span class="label label-success">可见</span><?php endif; ?>
                    </td>
                    <td>
                        <?php if($vo["isavailable"] == 0): ?><span class="label label-default">不可用</span>
                            <?php else: ?>
