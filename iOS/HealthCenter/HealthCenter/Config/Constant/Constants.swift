...
//MARK: 通用/全局 - Common
//项目全称
let PROJECT_COMMON_NAME_CHN: String = "蓝牙-中央设备Demo"
let PROJECT_COMMON_NAME_ENG: String = "HealthCenter"
//项目名称缩写
let PROJECT_COMMON_NAME_SHORT: String = "BLE-HC"
//项目版本号，默认0.0.1
...
//MARK: 启动页 - Launch
//是否显示启动页，默认显示
let PROJECT_LAUNCH_AVAILABLE: Bool = true
//是否可以跳过启动页，默认可以
...
//MARK: 引导页 - Guide
//是否显示引导页，默认显示
let PROJECT_GUIDE_AVAILABLE: Bool = true
//是否可以跳过引导页，默认可以
...
//是否启用入口页，默认开启
let PROJECT_ENTRANCE_AVAILABLE: Bool = true
//是否可以跳过入口页，默认可以
...
let PROJECT_VIEW_SUBJECT_COLOR: UIColor = UIColor.orangeColor()
//项目导航条颜色，默认主题颜色相同
