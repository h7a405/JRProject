...
+(BOOL)validateMobile:(NSString *)mobileNum
{
    ...
    NSString * MOBILE_FORMAT = @"1[3|5|7|8|][0-9]{9}";
    NSPredicate *regextestformat = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", MOBILE_FORMAT];
    if([regextestformat evaluateWithObject:mobileNum] != YES){
        return NO;
    }
