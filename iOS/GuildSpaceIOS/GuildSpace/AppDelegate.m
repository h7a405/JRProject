...
//    
//    tabBarViewCtrl.viewControllers = @[homeNaviCtrl, messageNaviCtrl, playerNaviCtrl];
    
//    [[UINavigationBar appearance] setTintColor:[Common getColorWithRGB:0x01e4e0]];
//    [[UINavigationBar appearance] setBarStyle:UIBarStyleBlack];
//    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];
    
    self.rootViewCtrl = [[ViewController alloc]init];
    self.rootViewCtrl.view.frame = [UIScreen mainScreen].bounds;
    
//    self.window.rootViewController = rootViewCtrl;
    [self.window addSubview:self.rootViewCtrl.view];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "crew.JL.GuildSpace" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"GuildSpace" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"GuildSpace.sqlite"];
    NSError *error = nil;
